Locales['fr'] = {
	...
	-- Main Menu
	['mainmenu_subtitle'] = '~r~NeyRox',
	['mainmenu_gps_button'] = '~b~GPS',
	...
	-- Inventory Menu
	['inventory_title'] = '~b~Inventaire',
	['inventory_actions_title'] = '~b~Inventaire: Action',
	['inventory_use_button'] = '~r~Utiliser',
	['inventory_give_button'] = '~r~Donner',
	['inventory_drop_button'] = '~r~Jeter',

	-- Loadout Menu
	['loadout_title'] = '~b~Gestion des Armes',
	['loadout_actions_title'] = '~b~Armes: Action',
	['loadout_give_button'] = '~r~Donner',
	['loadout_givemun_button'] = '~r~Donner Munitions',
	['loadout_drop_button'] = '~r~Jeter',

	-- Wallet Menu
	['wallet_title'] = '~b~Portefeuille',
	['wallet_option_give'] = '~r~Donner',
	['wallet_option_drop'] = '~r~Jeter',
	['wallet_job_button'] = '~p~Métier: %s - %s',
	['wallet_job2_button'] = '~r~Organisation: %s - %s',
	['wallet_money_button'] = '~p~Argent: $%s',
	['wallet_bankmoney_button'] = '~y~Banque: $%s',
	['wallet_blackmoney_button'] = '~r~Argent Sale: $%s',
	['wallet_money_separator'] = '~u~-------------------------------------------',
	['wallet_show_idcard_button'] = '~b~→→ Montrer sa carte d\'identité',
	['wallet_check_idcard_button'] = '~b~→→ ~g~Regarder sa carte d\'identité',
	['wallet_show_driver_button'] = '~b~→→ Montrer son permis de conduire',
	['wallet_check_driver_button'] = '~b~→→ ~g~Regarder son permis de conduire',
	['wallet_show_firearms_button'] = '~b~→→ Montrer son permis port d\'armes',
	['wallet_check_firearms_button'] = '~b~→→ ~g~Regarder son permis port d\'armes',

	-- Bills Menu
	['bills_title'] = '~b~Factures',
	...
	-- Vehicle Menu
	['vehicle_title'] = '~b~→→ ~b~Gestion Véhicule',
	...
	['bossmanagement_title'] = '~b~→→ ~b~Gestion Entreprise',
	...
	['bossmanagement2_title'] = '~b~→→ ~b~Gestion Organisation',
	...
	-- Admin Menu
	['admin_title'] = '~b~→→ ~b~Administration',
	['admin_title_menu'] = 'Administration',
